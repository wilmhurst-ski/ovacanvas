import {Node, Scene2D} from '@ovacanvas/2d';
import {SceneRenderEvent} from '@ovacanvas/core';
import {useApplication, useCurrentScene} from '@ovacanvas/ui';
import {
  ReadonlySignal,
  Signal,
  computed,
...
export const NodeInspectorKey = '@ovacanvas/2d/node-inspector';
