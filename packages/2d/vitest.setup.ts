import {Matrix2D} from '@ovacanvas/core';
 ...
 * is no reason to keep that limit for this subset of cases. (The same stub
 * is used by the core suite; kept as a separate copy there since core can't
 * depend on its own not-yet-built package during its own tests.)
 */
class TestDOMMatrix {
