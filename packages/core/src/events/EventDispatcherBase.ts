...
> {
  ...
  /**
   * The number of subscribers currently retained by this dispatcher.
   *
   * @remarks
   * Exposed so that teardown can be asserted to be symmetrical: after a
   * runtime is disposed every dispatcher it owned must be back at zero.
   *
   * @internal
   */
...
> {
  ...
  /**
   * {@inheritDoc EventDispatcherBase.getSubscriberCount}
   *
   * @internal
   */
  public getSubscriberCount(): number {
