  ...
  fields: {
    parts: {
      ...
      doc: [
        ...
        'Arrow as a vector: {"from": p, "dir": d, "length": n}; d is degrees (0 = right, 90 = up), "up"/"down"/"left"/"right", "up <line>"/"down <line>" (along it, uphill/downhill), "along"/"against <line>", "out <surface>"/"into <surface>" (perpendicular), "toward <part>". A component: {"from": p, "component": "<vector part>", "dir": d} - its length is worked out. A pointer: {"to": part, "from": "below"|"above"|"left"|"right"}.',
