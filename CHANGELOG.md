...
> **Note:** every entry below predates the OvaCanvas fork and is the release
> history of [Motion Canvas](https://github.com/motion-canvas/motion-canvas),
> retained unchanged as upstream history. Version numbers and links refer to
> upstream releases. OvaCanvas has not published a release of its own.
